...
export const EXTRA_MCP_TOOLS = [
  ...
  }, ['id', 'projectRoot'], hints(false, false, true)),
  ...
  }, ['content', 'projectRoot'], hints(false, false, false)),
  ...
  }, ['id', 'projectRoot'], hints(false, false, false)),
  ...
  toolSpec('memory_cleanup', 'Preview project retention candidates by default; delete only with explicit apply=true.', {
    projectRoot: projectTool,
    apply: { type: 'boolean', description: 'Apply hard deletion. Defaults to false for preview-only behavior.' },
    maxDelete: { type: 'number', description: 'Maximum memories to delete in one applied run (1-10000, default 1000).' },
  }, ['projectRoot'], hints(false, false, true)),
  ...
  }, ['calls', 'projectRoot'], hints(false, false, false)),
  ...
  }, ['filePath', 'startLine', 'projectRoot'], hints(true, false, false)),
  toolSpec('context_fetch_last_error', 'Retrieve the most recent cached error.', { sessionId: sessionTool, projectRoot: projectTool }, ['projectRoot'], hints(true, false, false)),
  ...
  }, ['description', 'projectRoot'], hints(false, false, false)),
  ...
  }, ['projectRoot'], hints(false, false, false)),
  ...
  }, ['messages', 'projectRoot'], hints(false, false, false)),
  ...
  }, ['limit', 'projectRoot'], hints(false, false, false)),
  ...
  }, ['refId', 'projectRoot'], hints(true, false, false)),
