...
export const DEFAULT_CONFIG: PluginConfig = {
  ...
  selfModel: {
    ...
    updateIntervalMs: getEnvNumber('CSM_SELF_MODEL_UPDATE_INTERVAL', 60000),
  ...
  beliefKnowledge: {
    ...
    consolidationIntervalMs: getEnvNumber('CSM_BELIEF_KNOWLEDGE_INTERVAL', 120000),
  ...
  beliefPromotion: {
    ...
    minReinforcement: getEnvNumber('CSM_BELIEF_PROMOTION_MIN_REINFORCEMENT', 3),
    minEvidenceRefs: getEnvNumber('CSM_BELIEF_PROMOTION_MIN_EVIDENCE_REFS', 2),
    minSessions: getEnvNumber('CSM_BELIEF_PROMOTION_MIN_SESSIONS', 1),
    maxPromotePerRun: getEnvNumber('CSM_BELIEF_PROMOTION_MAX_PROMOTE', 10),
  ...
  livingState: {
    ...
    maxAdvisoryBlockChars: getEnvNumber('CSM_LIVING_STATE_MAX_ADVISORY_CHARS', 1000),
